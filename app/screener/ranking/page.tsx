              ...
              <div className="flex items-start justify-between mb-3">
                <div>
                  <div className="flex items-center gap-2">
                    <Link
                      href={`/screener/stocks/${encodeURIComponent(stock.symbol)}`}
            ...
            <tbody>
              {current.map((stock, i) => (
                <tr key={stock.symbol} className="border-b border-slate-700/50 hover:bg-slate-700/30">
                  ...
                  <td className="px-3 py-2">
                    <Link href={`/screener/stocks/${encodeURIComponent(stock.symbol)}`} className="text-blue-400 hover:text-blue-300 text-xs">
                      詳細 →
                    </Link>
                  </td>
                </tr>
