      ...
      <div className="article-shell">
        <section className="article-hero">
          <div className="article-hero-card">
            ...
            <h1 className="page-title">小論文でよく出るテーマ例｜まず押さえたい頻出分野</h1>
            ...
            <div className="article-meta">
              <span className="article-chip">頻出テーマ</span>
              <span className="article-chip">出題対策</span>
              <span className="article-chip">事前準備向け</span>
            </div>
          </div>
        </section>
        ...
        <div className="article-body">
          <section className="article-section">
            <h2 className="article-section-title">1. 教育</h2>
          ...
          <section className="article-section">
            <h2 className="article-section-title">2. 科学技術・AI</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">3. 環境問題</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">4. 福祉・高齢化</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">5. 地域・コミュニティ</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">6. 多様性・共生</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">テーマを知ることは準備になる</h2>
          ...
          <section className="article-section">
            <div className="article-highlight">
              <strong>準備の考え方：</strong>
              テーマを覚えるのではなく、テーマごとに
              「どんな対立や課題があるか」を考える習慣をつけるのが大切です。
            </div>
          </section>
        </div>
