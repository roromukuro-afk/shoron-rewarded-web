...
const title = "200〜400字の小論文をうまくまとめるコツ";
const description =
  "200〜400字の小論文で主張を1つに絞り、短い字数でも分かりやすくまとめるコツを解説します。";
const path = "/guide/how-to-write-200-400";
const keywords = [
  "小論文",
  "200字 400字 小論文",
  "小論文 短い字数",
      ...
      <div className="article-shell">
        <section className="article-hero">
          <div className="article-hero-card">
            ...
            <div className="article-meta">
              <span className="article-chip">200〜400字</span>
              <span className="article-chip">短文対策</span>
              <span className="article-chip">字数制限対策</span>
            </div>
          </div>
        </section>
        ...
        <div className="article-body">
          <section className="article-section">
            <h2 className="article-section-title">1. 主張は1つに絞る</h2>
          ...
          <section className="article-section">
            <h2 className="article-section-title">2. 型を使う</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">3. 理由を具体化する</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">4. 具体例は一言で十分なこともある</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">5. 最後は必ず締める</h2>
            <div className="article-section-card">
              <p>
          ...
          <section className="article-section">
            <h2 className="article-section-title">短い小論文ほど設計が大切</h2>
          ...
          <section className="article-section">
            <div className="article-highlight">
              <strong>コツ：</strong>
              短い字数ほど「全部書こう」としないことが大切です。
              1つの主張を短く強く伝える方が評価されやすいです。
            </div>
          </section>
        </div>
